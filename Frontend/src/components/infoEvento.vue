    ...
    <div class="max-w-4xl mx-auto p-6 max-h-[90vh] overflow-auto">
        <div class="card lg:card-side bg-base-100 shadow-xl">
            ...
            <div class="card-body">
                ...
                <p><strong>Luogo:</strong> {{ props.event.location.via }} {{ props.event.location.number }}, {{ props.event.location.city }} ({{ props.event.location.CAP }})</p>
                ...
                <div class="card-actions justify-end">
                    ...
                    <div v-else-if="role === 'organization'">
        ...
        <div v-if="modifyEvent" class="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center">
            <creaEvento :event="props.event" @close="modifyEvent = false"/>
        </div>
    </div>
</template>